...
public class Crusoe10Activity extends CrusoeNavActivity 
	{
	/*
    ...
    protected void initialiseTabHost() {
        ...
        Crusoe10Activity.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("DataTab").setIndicator("Data"));
        Crusoe10Activity.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("MapTab").setIndicator("MapView"));
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try{
	        ...
	        if(mViewPager!=null)
	        {
	        	...
	        	// Tab Initialization
	        	//initialiseTabHost();
	        	mAdapter = new CrusoeNav10PagerAdapter(getSupportFragmentManager());
	        	// Fragments and ViewPager Initialization
	       	        
	        	mViewPager.setAdapter(mAdapter);
	        	mViewPager.setOnPageChangeListener(Crusoe10Activity.this);
	        }
		}
		catch(Exception e)
		{
