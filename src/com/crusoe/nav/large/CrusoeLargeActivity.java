...
import com.crusoe.nav.normal.CrusoeNormalPagerAdapter;
...
public class CrusoeLargeActivity extends CrusoeNavActivity 
	{
	/*
	  ...
	  /*
		...
		if(size != Configuration.SCREENLAYOUT_SIZE_SMALL)
		{
		    ...
		    if(newConfig.orientation == Configuration.ORIENTATION_PORTRAIT)
				setContentView(R.layout.large_port);
			  else
				setContentView(R.layout.large_land);
		}*/
	}
    ...
    protected void initialiseTabHost() {
        ...
        CrusoeLargeActivity.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("DataTab").setIndicator("Data"));
        CrusoeLargeActivity.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("MapTab").setIndicator("MapView"));
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try{
	        ...
	        if(mViewPager!=null)
	        {
	        	...
	        	mViewPager.setOnPageChangeListener(CrusoeLargeActivity.this);
	        }
		}
		catch(Exception e)
		{
