...
public class CrusoeItemizedOverlayWithFocus<Item extends OverlayItem> extends ItemizedIconOverlay<Item> {
	...
	protected static final int DEFAULTMARKER_BACKGROUNDCOLOR = Color.WHITE;
	...
	public CrusoeItemizedOverlayWithFocus(final Context ctx, final List<Item> aList,
			final OnItemGestureListener<Item> aOnItemTapListener) {
		this(aList, aOnItemTapListener, new DefaultResourceProxyImpl(ctx));
	}

	public CrusoeItemizedOverlayWithFocus(final List<Item> aList,
	...
	public CrusoeItemizedOverlayWithFocus(final List<Item> aList, final Drawable pMarker,
